...
wet.builder.environment = function(opt_data, opt_ignored) {
  return (opt_data.cdnEnv == 'qat' || opt_data.cdnEnv == 'nonprod' || opt_data.cdnEnv == 'esdcprod') ? '/cdts/gcintranet/release/' : (opt_data.cdnPath != null) ? soy.$$escapeHtml(opt_data.cdnPath) : '/etc/designs/canada/cdts/gcintranet/release/';
};
...
wet.builder.refTop = function(opt_data, opt_ignored) {
  opt_data = opt_data || {};
  return '\t<!--[if gte IE 9 | !IE ]><!--><link href=\'' + wet.builder.environment(opt_data) + 'assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'css/theme.min.css\'><!--<![endif]--><!--[if lt IE 9]><link href=\'' + wet.builder.environment(opt_data) + 'assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'css/ie8-theme.min.css\' /><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"><\/script><script src=\'' + wet.builder.environment(opt_data) + '/js/ie8-wet-boew.min.js\'><\/script><![endif]--><!--[if lte IE 9]><![endif]--><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'css/gctheme.css\'>' + ((opt_data.subTheme == 'esdc' || opt_data.subTheme == 'labour') ? '<link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'css/esdc.css\'>' : (opt_data.subTheme == 'eccc') ? '<link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'css/eccc.css\'>' : '') + '<link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'css/intranet.css\'>';
};
