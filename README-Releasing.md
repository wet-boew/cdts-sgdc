...
1. To release on the intranet (cdts-sgdc.service.canada.ca), we have to push our final build files to the production repository containing all the previous CDTS versions. Start by cloning the following repository: https://github.com/wet-boew/cdts-sgdc-dist.git
...
8. Once the pipeline has successfully ran, you can verify the release on https://cdts-sgdc.service.canada.ca/app/cls/WET/gcweb/vX_X_XX/cdts/samples/
