...
- L’URL GCIntranet https://templates.service.gc.ca a été remplacée par une URL bilingue https://cdts-sgdc.service.canada.ca.
...
- Mise à jour [BOEW](https://github.com/wet-boew/wet-boew/releases/) a v4.0.85 pour GCIntranet.
...
- Ajout d'un paramètre optionnel *languagePrecedence* à la page d'accueil permettant aux utilisateurs de décider de l'ordre des langues officielles
- Modifications et optimisations internes
- Corrections de bogues

## v5.0.4.1

- Modifications apportées au modèle GCIntranet pour l’accessibilité.
