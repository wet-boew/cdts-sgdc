  ...
  if (opt_data.search != false) {
    ...
    if (opt_data.customSearch != null) {
      ...
      for (var itemIndex136 = 0; itemIndex136 < itemListLen136; itemIndex136++) {
        ...
        if (itemIndex136 == 0) {
          output += '<form action="' + ((itemData136.action != null) ? soy.$$escapeHtml(itemData136.action) : 'https://intranet.canada.ca/search-recherche/query-recherche-eng.aspx') + '" method="' + ((itemData136.method != null) ? soy.$$escapeHtml(itemData136.method) : 'get') + '" name="' + ((itemData136.name != null) ? soy.$$escapeHtml(itemData136.name) : 'cse-search-box') + '" role="search" class="form-inline"><div class="form-group"><label for="' + ((itemData136.id != null) ? soy.$$escapeHtml(itemData136.id) : 'wb-srch-q') + '" class="wb-inv">' + ((itemData136.placeholder != null) ? soy.$$escapeHtml(itemData136.placeholder) : 'Search GCintranet') + '</label><input class="wb-srch-q form-control pull-right" id="' + ((itemData136.id != null) ? soy.$$escapeHtml(itemData136.id) : 'wb-srch-q') + '" name="' + ((itemData136.name != null) ? soy.$$escapeHtml(itemData136.name) : 'q') + '"  value="" size="21" maxlength="150" placeholder="' + ((itemData136.placeholder != null) ? soy.$$escapeHtml(itemData136.placeholder) : 'Search GCintranet') + '">';
...
wet.builder.appTop = function(opt_data, opt_ignored) {
  ...
  if (opt_data.signOut != null) {
    ...
    for (var buttonIndex572 = 0; buttonIndex572 < buttonListLen572; buttonIndex572++) {
      ...
      output += (buttonIndex572 == 0) ? '<p><a href="' + soy.$$escapeHtml(buttonData572.href) + '" class="btn btn-default btn btn-signoff"><i class="glyphicon glyphicon-off mrgn-rght-md"></i>Sign out</a></p>' : '';
    }
    output += '</div></div>';
    ...
    for (var buttonIndex582 = 0; buttonIndex582 < buttonListLen582; buttonIndex582++) {
      ...
      output += (buttonIndex582 == 0) ? '<p><a href="' + soy.$$escapeHtml(buttonData582.href) + '" class="btn btn-default btn btn-signoff"><i class="glyphicon glyphicon-off mrgn-rght-md"></i>Sign in</a></p>' : '';
    }
    output += '</div></div>';
  } else {
  }
  ...
  if (opt_data.menuLinks != null) {
    ...
    for (var linkIndex595 = 0; linkIndex595 < linkListLen595; linkIndex595++) {
      ...
      if (linkData595.subLinks != null) {
        output += '<li><a href="#' + soy.$$escapeHtml(linkData595.id) + '" class="item"' + ((linkData595.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData595.text) + ((linkData595.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="sm list-unstyled" id="' + soy.$$escapeHtml(linkData595.id) + '" role="menu">';
        ...
        for (var sublinkIndex612 = 0; sublinkIndex612 < sublinkListLen612; sublinkIndex612++) {
          ...
          output += (sublinkIndex612 == sublinkListLen612 - 1) ? '<li class="slflnk"><a href="' + soy.$$escapeHtml(sublinkData612.subhref) + '"' + ((sublinkData612.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData612.subtext) + ((sublinkData612.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '<li><a href="' + soy.$$escapeHtml(sublinkData612.subhref) + '"' + ((sublinkData612.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData612.subtext) + ((sublinkData612.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData595.href) + '" class="item"' + ((linkData595.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData595.text) + ((linkData595.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
  ...
  for (var sectionIndex716 = 0; sectionIndex716 < sectionListLen716; sectionIndex716++) {
    ...
    for (var linkIndex735 = 0; linkIndex735 < linkListLen735; linkIndex735++) {
      ...
      if (linkData735.subLinks != null) {
        output += '<li><a href="' + soy.$$escapeHtml(linkData735.href) + '" class="list-group-item"' + ((linkData735.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData735.text) + ((linkData735.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="list-group menu list-unstyled">';
        ...
        for (var sublinkIndex750 = 0; sublinkIndex750 < sublinkListLen750; sublinkIndex750++) {
          ...
          output += '<li><a href="' + soy.$$escapeHtml(sublinkData750.subhref) + '" class="list-group-item"' + ((sublinkData750.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData750.subtext) + ((sublinkData750.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData735.href) + '" class="list-group-item"' + ((linkData735.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData735.text) + ((linkData735.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
    output += '</ul></section>';
  }
        ...
        if (footerSectionData814.customFooterLinks != null) {
          if (footerSectionIndex814 < 3) {
            ...
            for (var linkIndex826 = 0; linkIndex826 < linkListLen826; linkIndex826++) {
              ...
              output += '<li><a href="' + soy.$$escapeHtml(linkData826.href) + '"' + ((linkData826.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData826.text) + ((linkData826.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
            }
            output += '</ul></section>';
          }
          ...
          for (var linkIndex849 = 0; linkIndex849 < linkListLen849; linkIndex849++) {
            ...
            output += '<li><a href="' + soy.$$escapeHtml(linkData849.href) + '"' + ((linkData849.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData849.text) + ((linkData849.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></section>';
        }
      }
        ...
        if (footerSectionData868.customFooterLinks != null) {
          if (footerSectionIndex868 < 3) {
            ...
            for (var linkIndex880 = 0; linkIndex880 < linkListLen880; linkIndex880++) {
              ...
              output += '<li><a href="' + soy.$$escapeHtml(linkData880.href) + '"' + ((linkData880.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData880.text) + ((linkData880.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
            }
            output += '</ul></section>';
          }
          ...
          for (var linkIndex903 = 0; linkIndex903 < linkListLen903; linkIndex903++) {
            ...
            output += '<li><a href="' + soy.$$escapeHtml(linkData903.href) + '"' + ((linkData903.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData903.text) + ((linkData903.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></section>';
        }
      }
        ...
        if (footerSectionData922.customFooterLinks != null) {
          if (footerSectionIndex922 < 3) {
            ...
            for (var linkIndex934 = 0; linkIndex934 < linkListLen934; linkIndex934++) {
              ...
              output += '<li><a href="' + soy.$$escapeHtml(linkData934.href) + '"' + ((linkData934.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData934.text) + ((linkData934.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
            }
            output += '</ul></section>';
          }
          ...
          for (var linkIndex957 = 0; linkIndex957 < linkListLen957; linkIndex957++) {
            ...
            output += '<li><a href="' + soy.$$escapeHtml(linkData957.href) + '"' + ((linkData957.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData957.text) + ((linkData957.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></section>';
        }
      }
...
wet.builder.splashTop = function(opt_data, opt_ignored) {
  return '\t\t<!--[if gte IE 9 | !IE ]><!--><link href=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/css/theme.min.css\'><!--<![endif]--><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/css/messages.min.css\'><!--[if lt IE 9]><link href=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/css/messages-ie.min.css\' /><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/css/ie8-theme.min.css\' /><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"><\/script><script src=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/js/ie8-wet-boew.min.js\'><\/script><![endif]--><link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'cdts/css/intranet.css\'>';
};


wet.builder.splash = function(opt_data, opt_ignored) {
  var output = '\t\t<div id="bg"><img src=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/img/splash/sp-bg-2.jpg\' alt=""></div><main role="main"><div class="sp-hb"><div class="sp-bx col-xs-12"><h1 property="name" class="wb-inv">GC Intranet / Intranet du GC</h1><div class="row"><div class="col-xs-11 col-md-8"><img src=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/assets/sig-spl.svg\' width="283" alt="Government of Canada / Gouvernement du Canada" /></div></div><div class="row cdts-splash"><section class="col-xs-6 text-right" lang="en">' + ((opt_data.nameEng != null) ? '<h2>' + soy.$$escapeHtml(opt_data.nameEng) + '</h2>' : '<h2 class="wb-inv">Government of Canada</h2>') + '</section><section class="col-xs-6" lang="fr">' + ((opt_data.nameFra != null) ? '<h2>' + soy.$$escapeHtml(opt_data.nameFra) + '</h2>' : '<h2 class="wb-inv">Gouvernement du Canada</h2>') + '</section></div><row class="text-center">';
  var lang__soy1068 = navigator.language;
  output += '<ul class="list-inline lst-spcd"><li>' + ((lang__soy1068 == 'en-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-primary" lang="en">English</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-default" lang="en">English</a>') + '</li><li>' + ((lang__soy1068 == 'fr-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-primary" lang="fr">Français</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-default" lang="fr">Français</a>') + '</li></ul></row></div><div class="sp-bx-bt col-xs-12"><div class="row"><div class="col-xs-7 col-md-8"><a href="' + soy.$$escapeHtml(opt_data.termsEng) + '" class="sp-lk">Terms & conditions</a> <span class="glyphicon glyphicon-asterisk"></span> <a href="' + soy.$$escapeHtml(opt_data.termsFra) + '" class="sp-lk" lang="fr">Avis</a></div><div class="col-xs-5 col-md-4 text-right mrgn-bttm-md"><img src=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/assets/wmms-spl.svg\' width="127" alt="Symbol of the Government of Canada / Symbole du gouvernement du Canada" /></div></div></div></div></main><!--[if gte IE 9 | !IE ]><!--><script src=\'' + ((opt_data.jqueryEnv == 'external') ? 'https://ajax.googleapis.com/ajax/libs/' : wet.builder.environment(opt_data) + 'gcintranet/release/js/') + 'jquery/2.2.4/jquery.min.js\'><\/script><script src=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/js/wet-boew.min.js\'><\/script><!--<![endif]--><!--[if lt IE 9]><script src=\'' + wet.builder.environment(opt_data) + 'gcintranet/release/js/ie8-wet-boew2.min.js\'><\/script><![endif]-->';
  return output;
};
