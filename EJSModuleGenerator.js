...
*/
async function localizeEJSModule(srcDirPath, inputTemplateText, locale, ejsFilePath) {
...
*/
module.exports.compileEJSModule = async function compileEJSModule(srcDirPath, trgFilePath, locale = 'en', compileDebug = false) {
    ...
    for (let i = 0; i < files.length; i++) {
        ...
        const localizedTemplate = await localizeEJSModule(srcDirPath, await fs.promises.readFile(ejsFilePath, 'utf8'), locale, ejsFilePath);
